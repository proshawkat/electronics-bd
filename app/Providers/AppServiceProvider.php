...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        View::composer(['frontend.partials.header', 'frontend.partials.footer', 'frontend.partials.price_request_modal', 'frontend.partials.modal', 'frontend.contact', 'frontend.single_product', 'welcome'], function ($view) {
