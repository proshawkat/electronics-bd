                    ...
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3" id="cod_message_wrapper" style="display: none;">
                                ...
                                <textarea class="form-control" id="cod_unavailable_message" name="cod_unavailable_message" rows="3" placeholder="এই প্রোডাক্টে ক্যাশ অন ডেলিভারি পাওয়া যাবে না...">{{ $product->cod_unavailable_message }}</textarea>
