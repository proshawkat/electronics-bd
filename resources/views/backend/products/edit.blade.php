                ...
                <div class="col-md-4">
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="cash_on_delivery" name="cash_on_delivery" value="1" {{ $product->cash_on_delivery ? 'checked' : '' }} />
                            ...
                            <div class="mb-3" id="cod_message_wrapper" style="display: none;">
                                ...
                                <textarea class="form-control" id="cod_unavailable_message" name="cod_unavailable_message" rows="3" placeholder="This product is not available for cash on delivery...">{{ $product->cod_unavailable_message }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
