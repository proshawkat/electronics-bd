                                ...
                                <ul class="j-menu">
                                    ...
                                    <li class="menu-item flyout-menu-item flyout-menu-item-2 multi-level dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="" aria-expanded="false">
                                            ...
                                            <span class="open-menu collapsed" data-toggle="collapse" data-target="#collapse-68a48eab8af0b"><i class="fa fa-plus"></i></span>
                                        </a>
                                        <div class="dropdown-menu j-dropdown" id="collapse-68a48eab8af0b">
                                            <ul class="j-menu">
                                                ...
                                                <li class="menu-item menu-item-c279">
                                                    <a href="#"><span class="links-text">MOSFETs</span></a>
                                                </li>
