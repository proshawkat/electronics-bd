                ...
                <div class="top-menu top-menu-14">
                    <ul class="j-menu">
                        ...
                        <li class="menu-item top-menu-item top-menu-item-4">
                            <a href="tel:{{ $generalSettings->phone }}">
                                <span class="links-text">Students<s>with benifits</s></span>
                            </a>
                        </li>
                                ...
                                <ul class="j-menu">
                                    ...
                                    <li class="menu-item flyout-menu-item flyout-menu-item-2 multi-level dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <span class="open-menu collapsed" data-toggle="collapse" data-target="#collapse-68a48eab911f1"><i class="fa fa-plus"></i></span>
                                        </a>
                                        <div class="dropdown-menu j-dropdown" id="collapse-68a48eab911f1">
                                            <ul class="j-menu">
                                                <li class="menu-item menu-item-c278">
                                                    <a href="#"><span class="links-text">Optocoupler</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center td-image">
                                                <a href="https://www.citytechbd.com/Autonics-Temperature-Controller-Autonics-TCN4S-24R">
                                                    <img
                                            ...
                                            <td class="text-left td-name"><a href="https://www.citytechbd.com/Autonics-Temperature-Controller-Autonics-TCN4S-24R">Autonics Temperature Controller Autonics TCN4S-24R</a><br /></td>
                            ...
                            <li class="cart-totals">
                                <div>
                                    ...
                                    <div class="cart-buttons">
                                        <a class="btn-cart btn" href="https://www.citytechbd.com/index.php?route=checkout/cart"><i class="fa"></i><span>View Cart</span></a>
                                        <a class="btn-checkout btn" href="https://www.citytechbd.com/index.php?route=checkout/checkout"><i class="fa"></i><span>Checkout</span></a>
                                    </div>
                                </div>
                            </li>
                        </ul>
