        ...
        <div class="product-delivery">
            <div class="delivery-box">
                ...
                <div class="delivery-item">
                    ...
                    @else
                        <div class="delivery-text" style="color: #e74c3c;">
                            <strong>Cash on Delivery unavailable</strong>
                            @if($product->cod_unavailable_message)
                                <br><small>{{ $product->cod_unavailable_message }}</small>
                            @endif
                        </div>
                    @endif
                </div>
            ...
            <div class="delivery-box">
                ...
                <a href="tel:+88{{ $generalSettings->admin_whatsapp_number }}" class="delivery-item delivery-link text-gray">
                    ...
                    <div class="delivery-text">
                        <div class="delivery-phone">{{ $generalSettings->admin_whatsapp_number }}</div>
                        <small>10:00AM to 7:00PM (Friday Closed)</small>
                    </div>
                </a>
                
                <a href="https://wa.me/+88{{ $generalSettings->admin_whatsapp_number }}?text={{ urlencode(url()->current()) }}" target="_blank" rel="nofollow noopener noreferrer" class="delivery-item delivery-link text-whatsapp">
                                    ...
                                    <div class="product-thumb">
                                        <div class="image">
                                            <div class="quickview-button">
                                                ...
                                                @else
                                                    <a class="btn btn-quickview" data-toggle="modal" data-target="#whatsappModal" data-id="{{ $related->id }}" data-product="{{ $related->name }}" data-url="{{ url('product/'.$related->slug) }}">
                                            ...
                                            <div>
                                                ...
                                                @else
                                                    ...
                                                    <div class="text-center">
                                                        <button class="btn btn-cart" data-toggle="modal" data-target="#whatsappModal" data-product="{{ $related->name }}" data-url="{{ url('product/'.$related->slug) }}" style="display: inline-flex; align-items: center; justify-content: center; gap: 5px; float: none;">
