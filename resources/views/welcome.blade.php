                                            ...
                                            <div class="module-item module-item-1">
                                                <h3 class="title module-title">
                                                    <div class="section-arrow-header">
                                                        <span class="section-arrow-text">New Arrival</span>
                                                    </div>
                                                </h3>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-3">
                                                            <div class="product-layout has-extra-button">
                                                                <div class="product-thumb">
                                                                    ...
                                                                    <div class="caption">
                                                                        <div class="name">
                                                                            <a class="truncate-text" href="{{ url('product/'.$product->slug) }}">
                                                                                {{ $product->name }}
                                                                            </a>
                                                                        </div>
                                                                                ...
                                                                                <div class="buttons-wrapper">
                                                                                    <div class="button-group">
                                                                                        <div class="cart-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <a class="btn btn-cart" data-id="{{ $product->id }}" onclick="addToCart({{ $product->id }})" title="Add to Cart">
